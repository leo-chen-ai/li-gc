...
export function AppSidebar() {
  ...
  const effectiveRole = resolveEffectiveRoleCode(
    user?.role,
    currentRolePermissions?.code,
  );
  ...
  const sections: SidebarSection[] = [
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          title: "人脸识别日志",
          href: "/app/admin/face-recognition-logs",
          icon: FileClock,
        },
        {
          key: "attendance_alerts",
          title: "考勤预警",
          href: "/app/admin/attendance-alerts",
          icon: AlertCircle,
        },
        {
          key: "managed_attendance",
          title: "考勤托管（配置）",
          href: "/app/admin/managed-attendance",
          icon: CalendarClock,
        },
        {
          key: "supplemental_attendance",
          title: "考勤托管",
          href: "/app/admin/supplemental-attendance",
          icon: CalendarClock,
        },
        {
          key: "environment_monitoring",
          title: "环境检测",
          href: "/app/admin/environment-monitoring",
          icon: Leaf,
        },
        {
          key: "video_monitoring",
          title: "视频监控",
          href: "/app/admin/video-monitoring",
          icon: Camera,
        },
      ],
    },
      ...
      items: [
        {
          key: "quality_safety",
          title: "质安管理",
          href: "/app/admin/quality-safety",
          icon: ClipboardCheck,
        },
        {
          key: "safety_management",
          title: "安全管理",
          href: "/app/admin/safety-management",
          icon: ShieldAlert,
        },
        {
          key: "material_management",
          title: "材料管理",
          href: "/app/admin/material-management",
          icon: Package,
        },
        {
          key: "construction_site",
          title: "施工现场",
          href: "/app/admin/construction-site",
          icon: HardHat,
        },
        {
          key: "party_building",
          title: "智慧党建",
          href: "/app/admin/party-building",
          icon: Landmark,
        },
        {
          key: "emergency_management",
          title: "应急管理",
          href: "/app/admin/emergency-management",
          icon: Siren,
        },
      ],
    },
      ...
      items: [
        {
          ...
          title: "人员信息列表",
          href: "/app/admin/personnel-workers",
          icon: Users,
        },
        {
          key: "personnel_contracts",
          title: "人员合同信息",
          href: "/app/admin/personnel-contracts",
          icon: FileText,
        },
        {
          key: "personnel_qualifications",
          title: "人员资格信息",
          href: "/app/admin/personnel-qualifications",
          icon: ShieldCheck,
        },
        {
          key: "personnel_registrations",
          title: "人员注册信息",
          href: "/app/admin/personnel-registrations",
          icon: ClipboardCheck,
        },
        {
          key: "personnel_bad_records",
          title: "人员不良信息",
          href: "/app/admin/personnel-bad-records",
          icon: AlertCircle,
        },
        {
          key: "personnel_approvers",
          title: "审批人员设置",
          href: "/app/admin/personnel-approvers",
          icon: UserCog,
        },
      ],
    },
    ...
    },
    {
      title: "系统",
      items: [
        ...(releaseFeatures.faceLibrarySync
          ? [
              {
                key: "face_library_sync" as MenuPermissionKey,
                title: "人脸库同步",
                href: "/app/admin/face-library-sync",
                icon: Fingerprint,
              },
            ]
          : []),
        {
          ...
          title: "注册列表",
          href: "/app/admin/registration-leads",
          icon: ClipboardCheck,
        },
        {
          key: "users",
