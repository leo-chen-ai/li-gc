...
import { Route as AppAdminFaceLibrarySyncRouteImport } from './routes/app/admin/face-library-sync'
...
const AppAdminFaceLibrarySyncRoute = AppAdminFaceLibrarySyncRouteImport.update({
  id: '/face-library-sync',
  path: '/face-library-sync',
  getParentRoute: () => AppAdminRoute,
} as any)
...
export interface FileRoutesByFullPath {
  ...
  '/app/data-screen': typeof AppDataScreenRouteWithChildren
  ...
  '/app/admin/face-library-sync': typeof AppAdminFaceLibrarySyncRoute
  ...
  '/app/data-screen/': typeof AppDataScreenIndexRoute
  ...
  '/app/data-screen/project/$projectId': typeof AppDataScreenProjectProjectIdRoute
}
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/app/admin/face-library-sync': {
      id: '/app/admin/face-library-sync'
      path: '/face-library-sync'
      fullPath: '/app/admin/face-library-sync'
      preLoaderRoute: typeof AppAdminFaceLibrarySyncRouteImport
      parentRoute: typeof AppAdminRoute
    }
    '/app/admin/environment-monitoring': {
...
interface AppAdminRouteChildren {
  ...
  AppAdminFaceLibrarySyncRoute: typeof AppAdminFaceLibrarySyncRoute
...
const AppAdminRouteChildren: AppAdminRouteChildren = {
  ...
  AppAdminFaceLibrarySyncRoute: AppAdminFaceLibrarySyncRoute,
...
interface AppDataScreenRouteChildren {
  AppDataScreenIndexRoute: typeof AppDataScreenIndexRoute
  AppDataScreenProjectProjectIdRoute: typeof AppDataScreenProjectProjectIdRoute
}

const AppDataScreenRouteChildren: AppDataScreenRouteChildren = {
  AppDataScreenIndexRoute: AppDataScreenIndexRoute,
  AppDataScreenProjectProjectIdRoute: AppDataScreenProjectProjectIdRoute,
}

const AppDataScreenRouteWithChildren = AppDataScreenRoute._addFileChildren(
  AppDataScreenRouteChildren,
)
...
interface AppRouteChildren {
  ...
  AppDataScreenRoute: typeof AppDataScreenRouteWithChildren
...
const AppRouteChildren: AppRouteChildren = {
  ...
  AppDataScreenRoute: AppDataScreenRouteWithChildren,
