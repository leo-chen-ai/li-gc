...
const statusClass: Record<ProjectStatus | "正常" | "关注" | "预警" | "在场" | "离场" | "未认证" | "有效" | "待补图" | "异常" | "待完善" | "草稿" | "导入" | "已确认" | "已发放", string> = {
  ...
  草稿: "border-slate-200 bg-slate-50 text-slate-700 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-300",
  导入: "border-sky-200 bg-sky-50 text-sky-700 dark:border-sky-900 dark:bg-sky-950 dark:text-sky-300",
  已确认: "border-emerald-200 bg-emerald-50 text-emerald-700 dark:border-emerald-900 dark:bg-emerald-950 dark:text-emerald-300",
  已发放: "border-emerald-200 bg-emerald-50 text-emerald-700 dark:border-emerald-900 dark:bg-emerald-950 dark:text-emerald-300",
};
