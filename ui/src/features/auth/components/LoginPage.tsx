  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#e7f0ed] text-slate-950 dark:bg-[#071f22] dark:text-white">
      ...
      <div className="relative mx-auto grid min-h-screen w-full max-w-7xl grid-rows-[auto_1fr] px-5 py-6 sm:px-8 lg:px-10">
        ...
        <main className="grid items-center gap-7 py-7 lg:grid-cols-[minmax(0,1fr)_minmax(380px,440px)] lg:gap-14 lg:py-8">
