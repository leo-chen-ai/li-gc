export const API_ENDPOINTS = {
  ...
  ADMIN: {
    ...
    REPORT_FORWARD_SUMMARY: "/admin/report-forward/summary",
    REPORT_FORWARD_CONFIGS: "/admin/report-forward/configs",
    REPORT_FORWARD_CONFIG: (configId: string) => `/admin/report-forward/configs/${configId}`,
    REPORT_FORWARD_CONFIG_RUNS: (configId: string) => `/admin/report-forward/configs/${configId}/runs`,
    REPORT_FORWARD_RUNS: "/admin/report-forward/runs",
    REPORT_FORWARD_RUN: (runId: string) => `/admin/report-forward/runs/${runId}`,
    REPORT_FORWARD_RUN_CANCEL: (runId: string) => `/admin/report-forward/runs/${runId}/cancel`,
    REPORT_FORWARD_RUN_RETRY: (runId: string) => `/admin/report-forward/runs/${runId}/retry`,
      REPORT_FORWARD_ITEMS: "/admin/report-forward/items",
      REPORT_FORWARD_ITEMS_EXPORT: (runId: string) => `/admin/report-forward/runs/${runId}/items/export`,
    REPORT_FORWARD_ARTIFACT_DOWNLOAD: (artifactId: string) => `/admin/report-forward/artifacts/${artifactId}/download`,
