...
const FAIL_INELIGIBLE_RETRY_REPORTS_SQL: &str = r#"
        ...
        WHERE r.worker_id = w.id
          ...
          AND COALESCE(r.device_type, '') <> '弹厂家'
...
const CLAIM_RETRY_REPORTS_SQL: &str = r#"
        ...
        WHERE r.id IN (
            ...
            WHERE due.is_deleted = FALSE
              ...
              AND COALESCE(due.device_type, d.device_type, '') <> '弹厂家'
...
mod tests {
    ...
    fn retry_claim_requires_active_worker_and_missing_ack() {
        ...
        assert!(CLAIM_RETRY_REPORTS_SQL.contains("<> '弹厂家'"));
        assert!(FAIL_INELIGIBLE_RETRY_REPORTS_SQL.contains("<> '弹厂家'"));
    }
    ...
    fn exhausted_reports_fail_after_final_ack_window() {
        ...
        assert!(FAIL_EXHAUSTED_RETRY_REPORTS_SQL.contains("<> '弹厂家'"));
