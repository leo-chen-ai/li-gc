...
assert.match(attendanceJs, /fetchAttendanceCalendarAll/);
assert.match(attendanceJs, /buildDaySummaryByWorker/);
assert.match(attendanceJs, /daySummaryByWorker/);
assert.match(attendanceJs, /first_in_time|summary\.firstIn/);
assert.match(attendanceJs, /loadWorkerDayRecords/);
...
assert.match(apiConfig, /LOCAL_API_BASE_URL = "http:\/\/192\.168\.0\.106:8080\/api\/v1"/);
